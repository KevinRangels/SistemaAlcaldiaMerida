...
$upload_dir = '../archivos/curriculo/';
 ...
 if(!isset($errMSG))
 {
  $stmt = $DB_con->prepare('INSERT INTO curriculum(id_departamento,id_funcionario,userPic) VALUES(:uname, :ujob, :upic)');
           ...
           <div class="col-md-12">
               <div class="box">
                 <div class="box-header with-border">
                       <h1 class="box-title">Curriculum Vitae</h1>
