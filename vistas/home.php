<?php
 ...
 $conexion=$c->conexion();
   ...
   $sql4="SELECT  SUM(fami.menores_uno)           
   from cargafamilia as fami";
   $resultado4=mysqli_query($conexion,$sql4);

$sql5="SELECT  SUM(fami.menores_dos)
from cargafamilia as fami";
...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="">
         ...
         <li class="">
              <a href="funcionariosP.php">
              <i class="fa fa-address-card-o"></i><span>Personal</span>
                </span>
              </a>
  ...
  <!--Contenido-->
      ...
      <div class="content-wrapper">        
        ...
        <p class="full-box"><?php echo $ver4[0]; ?></p>
        <?php endwhile; ?>
					<small>Registrados</small>
				</div>
            </article>
        ...
        <div class="full-box tile-icon text-center">
				...
				<div class="full-box tile-number text-titles">
        <?php while($ver5=mysqli_fetch_row($resultado5)): ?>

        <p class="full-box"><?php echo $ver5[0]; ?></p>
        <?php endwhile; ?>
					<small>Registrado</small>
				</div>
			</article>
