...
$upload_dir = '../archivos/actasMatrimonio/';
 ...
 if(!isset($errMSG))
 {
  $stmt = $DB_con->prepare('INSERT INTO actam(id_departamento,id_funcionario,userPic) VALUES(:uname, :ujob, :upic)');
           ...
           <div class="col-md-12">
               <div class="box">
                 <div class="box-header with-border">
                       <h1 class="box-title">Actas de Matrimonio</h1>
