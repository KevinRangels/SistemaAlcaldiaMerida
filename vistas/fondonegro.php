...
$upload_dir = '../archivos/fondoNegro/';
 ...
 if(!isset($errMSG))
 {
  $stmt = $DB_con->prepare('INSERT INTO fondonegro(id_departamento,id_funcionario,userPic) VALUES(:uname, :ujob, :upic)');
           ...
           <div class="col-md-12">
               <div class="box">
                 <div class="box-header with-border">
                       <h1 class="box-title">Fondo Negro</h1>
